...
/**
 * Sends pointer motion event as if it was generated by actual mouse being moved.
 */
void wlc_view_pointer_motion(wlc_handle view, uint32_t time, const struct wlc_point *point);

/**
 * Sends pointer button event as if it was generated by pressing real button.
 */
void wlc_view_pointer_button(wlc_handle view, uint32_t time, uint32_t button, enum wlc_button_state state);

/**
 * Sends pointer button scroll as if it was generated by actual mouse scrolling.
 */
void wlc_view_pointer_scroll(wlc_handle view, uint32_t time, uint8_t axis_bits, double amount[2]);
